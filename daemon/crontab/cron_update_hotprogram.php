...
//		 $result = $this->objRadio->updateHotProgram(); //已经废弃 搬家到cron_update_hotprogrambyday.php updateHotProgramByDay2() 
		 //执行结束时间
		list($usec, $sec) = explode(" ", microtime());
...
$obj=new cron_update_hotprogram();
$obj->Run();
?>
