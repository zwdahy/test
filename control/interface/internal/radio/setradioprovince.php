...
/**
 * Project:     电台管理后台接口
 * File:        setradioprovince.php
 * 
 * 编辑地区首页
 * 
 * @link http://i.service.t.sina.com.cn/sapps/radio/setradioprovince.php
 * @copyright sina.com
...
class setRadioProvince extends control {
	...
	/*
	private function arrFansCmp($a,$b){
		if($a['attnum'] == $b['attnum']){
			return 0;
		}
		return($a['attnum']<$b['attnum']) ? 1 : -1;
	}
	*/
	
}

new setRadioProvince(RADIO_APP_SOURCE);
?>