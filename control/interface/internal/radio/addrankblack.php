...
/**
 * Project:     电台管理后台接口
 * File:        addrankblack.php
 * 
 * 添加活跃榜黑名单那
 * 
 * @link http://i.service.t.sina.com.cn/sapps/radio/addrankblack.php
 * @copyright sina.com
...
class addRankBlack extends control {
	protected function checkPara() {
		...
		$this->para['type'] = request::post('type', 'STR');		// 黑名单类型
		return true;
	}
...
new addRankBlack(RADIO_APP_SOURCE);
?>